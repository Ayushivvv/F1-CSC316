...
# --- INPUT PATH (READING THE CSV FILES) ---
...
if dfs:
    ...
    # Optional: drop duplicates based on 'Abbreviation'
    ...
    # --- NEW STEP: Drop rows where 'HeadshotUrl' is empty/missing (NaN) ---
    ...
    # --- OUTPUT PATH (SAVING THE FINAL CSV) ---
